...
$(function () {
    var buttonsView = new _views.ButtonsView({ model: _models.headerMenu });
    var collectionItemsView = new _views.CollectionItemsView({
        collection: _collections.postsList
    });
});
...
exports.CollectionCommentsView = exports.CollectionItemsView = exports.ButtonsView = undefined;

var _backbone = __webpack_require__(5);

var _collections = __webpack_require__(12);

var currentlyPostsNumber = _collections.postsNumber;

var ButtonsView = _backbone.View.extend({
    template: _.template('<button class = "filter-button" id="filter-button-social">Social</button> ' + '<button class = "filter-button" id="filter-button-discovery"> Discovery </button>'),
    render: function render() {
    ...
    onClickSocial: function onClickSocial() {
        (0, _collections.onClickSocial)();
    },
    onClickDiscovery: function onClickDiscovery() {
        (0, _collections.onClickDiscovery)();
    }
});
...
var ItemsView = _backbone.View.extend({
    tagName: 'div',
    id: 'item',
    className: 'item',
    template: _.template("<div class= 'author'>" + "<img src= <%=author.image_url%> class = 'author-img'>" + "<div class = 'author-details'>" + "<p class = 'name'><%= author.name%></p>" + "<p class = 'time'><%= timestamp%></p>" + "</div>" + "</div>" + "<div class = 'post-body'><%= body %></div>" + "<div class = 'post-comments'>" + "<div class = 'post-comments-controls'>" + "<button class='comments-buttons'><img src=\"../assets/logo.png\"/><%= ratings_count%></button>" + "<button class='comments-buttons'><img src=\"../assets/message.png\"/><%= comments_count %></button>" + "<button class='comments-buttons'><img src=\"../assets/share.png\"/><%= shares_count %></button>" + "</div>" + "<div id= <%= id%> class='comments-body'></div>" + "</div>"),
    ...
    onClickComments: function onClickComments() {
        var _this = this;

        var localList = _collections.commentsList;
        if (localList) {
            if (this.model.attributes.opened) {
                ...
                localList = localList.filter(function (item) {
                    return item.attributes.topic_id === _this.model.attributes.id;
                });
            }
        }
        var collectionCommentsView = new CollectionCommentsView({
            el: '#' + this.model.attributes.id,
            collection: localList
        });
    }
});
var CommentsView = _backbone.View.extend({
    tagName: 'div',
    id: 'comment',
    className: 'comments-body',
    template: _.template("<div class= 'author-comment'>" + "<img src= <%=author.image_url%> class = 'author-img'>" + "</div>" + "</div>" + "<div class = 'comment-body'>" + "<div class = 'author-comment-details'>" + "<p class = 'name'><%= author.name%></p>" + "<p class = 'time'><%= timestamp%></p>" + "<%= body %>" + "</div>" + "</div>"),
...
var CollectionItemsView = Backbone.View.extend({
    el: '#items-container',
    render: function render() {
        this.addAll();
    },
    addOne: function addOne(post) {
        ...
        var postView = new ItemsView({ model: post });
    ...
    addAll: function addAll() {
        var element = document.getElementById('item');
        if (element) {
            for (var i = 0; i < currentlyPostsNumber; i++) {
                this.removeOne();
            }
...
var CollectionCommentsView = Backbone.View.extend({
    render: function render() {
        this.addAll();
    },
    addOne: function addOne(comment) {
        var commentView = new CommentsView({ model: comment });
...
exports.CollectionItemsView = CollectionItemsView;
exports.CollectionCommentsView = CollectionCommentsView;
...
exports.PostComment = exports.headerMenu = exports.Post = undefined;
...
exports.commentsList = exports.postsNumber = exports.onClickDiscovery = exports.onClickSocial = exports.postsList = undefined;

var _models = __webpack_require__(11);

var list = void 0;
var postsNumber = void 0;
var loadedPosts = void 0;
...
fetch('http://localhost:3000/posts').then(function (response) {
    ...
    list = data;
    exports.postsNumber = postsNumber = list.length;
});
var onClickSocial = function onClickSocial() {
    if (list) {
        var socialList = list.filter(function (item) {
            return item.topic_type === 'social';
        });
...
var onClickDiscovery = function onClickDiscovery() {
    if (list) {
        var discoveryList = list.filter(function (item) {
            return item.topic_type === 'discovery';
        });
...
var commentslist = void 0;

var CommentsList = Backbone.Collection.extend({
    url: '/comments',
    model: _models.PostComment
});
...
exports.onClickSocial = onClickSocial;
exports.onClickDiscovery = onClickDiscovery;
exports.postsNumber = postsNumber;
